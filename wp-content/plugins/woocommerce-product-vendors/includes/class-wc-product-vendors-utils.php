...
class WC_Product_Vendors_Utils {
	 ...
	 * @return string|bool
	 */
	public static function get_user_active_vendor() {
		$vendor_id = get_user_meta( get_current_user_id(), '_wcpv_active_vendor', true );
	 ...
	 * @return string|bool
	 */
	public static function get_user_default_vendor() {
		$vendor_data = self::get_all_vendor_data( get_current_user_id() );
	...
	public static function is_bookings_enabled() {
		$vendor_data = get_term_meta( self::get_logged_in_vendor(), 'vendor_data', true );
